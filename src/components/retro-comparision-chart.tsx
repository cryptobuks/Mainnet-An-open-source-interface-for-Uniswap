...
export default function ComparisonChart() {
  ...
  return (
    <div className="rounded-lg bg-white shadow-card dark:bg-light-dark flex-auto mx-4 w-64">
      <div className="light:border light:border-slate-200 rounded-lg bg-white shadow-card dark:bg-light-dark sm:px-8 pt-8 flex  justify-between	">
        <div className='pb-12'>
      ...
      <div className="px-3 pb-4  mt-5 h-56 sm:mb-12 md:h-96 lg:h-[416px] xl:h-[479px] 3xl:h-[496px] 4xl:h-[580px]">

...
//   ROUTER__ADDRESS = '0x23BCcEad0f72da6735eFf9a2eAc4d9584EF9B43d'
// } else if (Number(localStorage.getItem('chainId')) === 421611) {
//   ROUTER__ADDRESS = '0x58f9F38c78D944d73398cCd463e2C2e1ACC12629'
// } else {
//   ROUTER__ADDRESS = '0x23BCcEad0f72da6735eFf9a2eAc4d9584EF9B43d'
// }

//let ROUTER__ADDRESS
//console.log('CHAIN ID is SDK', localStorage.getItem('chainId'))
// if (Number(localStorage.getItem('chainId')) === 4) {
//   ROUTER__ADDRESS = '0xcEAD1662d943DbaABe9Aa36a2610465009f8Fc4f'
// } else if (Number(localStorage.getItem('chainId')) === 421611) {
//   ROUTER__ADDRESS = '0xcEAD1662d943DbaABe9Aa36a2610465009f8Fc4f'
...
//   ROUTER__ADDRESS = '0xcEAD1662d943DbaABe9Aa36a2610465009f8Fc4f'
// } else if (Number(localStorage.getItem('chainId')) === 42161) {
//   ROUTER__ADDRESS = '0xcEAD1662d943DbaABe9Aa36a2610465009f8Fc4f'
...
//   ROUTER__ADDRESS = '0xcEAD1662d943DbaABe9Aa36a2610465009f8Fc4f'
// } else if (Number(localStorage.getItem('chainId')) === 69) {
//   ROUTER__ADDRESS = '0xcEAD1662d943DbaABe9Aa36a2610465009f8Fc4f'
...
//console.log('ROUTER ADDRESS is', ROUTER__ADDRESS)

export const ROUTER_ADDRESS = '0xcEAD1662d943DbaABe9Aa36a2610465009f8Fc4f'
...
const WETH_ONLY: ChainTokenList = {
  ...
  // [ChainId.GOERIL]: [WETH[ChainId.GOERIL]],
  ...
  [ChainId.AVALANCHE_FUJI_TESTNET]: [WETH[ChainId.AVALANCHE_FUJI_TESTNET]],
  [ChainId.AVALANCHE_CMAINNET]: [WETH[ChainId.AVALANCHE_CMAINNET]],
  [ChainId.FANTOM_TESTNET]: [WETH[ChainId.FANTOM_TESTNET]],
  [ChainId.FANTOM]: [WETH[ChainId.FANTOM]],
  [ChainId.BNBTESTNET]: [WETH[ChainId.BNBTESTNET]],
  ...
  [ChainId.CELO_TESTNET]: [WETH[ChainId.CELO_TESTNET]],
  [ChainId.ETHClassic]: [WETH[ChainId.ETHClassic]]
}
